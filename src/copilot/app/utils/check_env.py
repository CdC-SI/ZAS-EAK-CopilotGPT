...
from config.llm_config import SUPPORTED_OPENAI_LLM_MODELS, SUPPORTED_AZUREOPENAI_LLM_MODELS, SUPPORTED_GROQ_LLM_MODELS, SUPPORTED_MLX_LLM_MODELS, SUPPORTED_OPENAI_EMBEDDING_MODELS, SUPPORTED_AZUREOPENAI_EMBEDDING_MODELS
...
def check_env_vars(config):
    ...
    supported_llm_models = SUPPORTED_OPENAI_LLM_MODELS + SUPPORTED_AZUREOPENAI_LLM_MODELS + SUPPORTED_GROQ_LLM_MODELS + SUPPORTED_MLX_LLM_MODELS
