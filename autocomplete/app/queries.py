...
async def fetch(db_name: str, select: [str] = None, where: [str] = None, language: str = '*', order: str = 'question', k: int = -1):
    conn = await connect()
...
async def exact_match(question: str, language: str = '*', k: int = -1):
...
async def fuzzy_match(question: str, language: str = '*', threshold: int = 5, k: int = -1):
    return await fetch('data',
...
async def semantic_similarity_match_l1(question: str, language: str = '*', k: int = -1):
    return semantic_similarity_match(question, language, symbol='<+>', k=k)


async def semantic_similarity_match_l2(question: str, language: str = '*', k: int = -1):
    return semantic_similarity_match(question, language, symbol='<->', k=k)


async def semantic_similarity_match_inner_prod(question: str, language: str = '*', k: int = -1):
    return semantic_similarity_match(question, language, symbol='<#>', k=k)
